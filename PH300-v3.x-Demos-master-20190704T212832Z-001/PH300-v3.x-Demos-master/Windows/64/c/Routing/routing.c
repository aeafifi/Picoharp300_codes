/************************************************************************
  ...
  PicoHarp 300    PHLIB.DLL  Interactive Mode Routing Demo in C

  Demo access to PicoHarp 300 Hardware via PHLIB.DLL v 3.0.
...
int main(int argc, char* argv[])
{
 ...
 printf("\nPicoHarp 300 PHLib DLL Routing Demo        M. Wahl, PicoQuant GmbH, 2013");
 printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
