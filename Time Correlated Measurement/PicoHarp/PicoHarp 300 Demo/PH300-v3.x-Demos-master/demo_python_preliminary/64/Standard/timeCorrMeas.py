...
class timeCorrelatedMeasurements(App):
    ...
    def onpageshow(self, emitter):
        ...
        if self.__pulseGen.getDevice() == 0:
            if self.__SPD.getDevAvbl() == 0:
                self.__textToBeDisplayed.set_text('No devices found...')
            if self.__SPD.getDevAvbl() == 1:
                self.__circle2.style["fill"] =  "#ff7837"
                self.__textToBeDisplayed.set_text('Pulse generator not found...')
            ...
            if self.__SPD.getDevAvbl() == 1:
                self.__circle2.style["fill"] =  "#ff7837"                       
                self.__textToBeDisplayed.set_text('Pulse generator and PicoHarp devices found...')
            else:
