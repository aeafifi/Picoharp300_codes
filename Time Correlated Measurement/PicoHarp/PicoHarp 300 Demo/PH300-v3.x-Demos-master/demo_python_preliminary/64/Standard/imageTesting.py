...
class untitled(App):
    def __init__(self, *args, **kwargs):
        ...
        if not 'editing_mode' in kwargs.keys():
            super(untitled, self).__init__(*args, static_file_path={'my_res':'./temporary/'})
    ...
    def construct_ui(self):
        ...
        image = Image('temporaryfile.png')
        image.attributes.update({"class":"Image","src":"temporaryfile.png","editor_constructor":"('temporaryfile.png')","editor_varname":"image","editor_tag_type":"widget","editor_newclass":"False","editor_baseclass":"Image"})
...
#Configuration
configuration = {'config_project_name': 'untitled', 'config_address': '0.0.0.0', 'config_port': 8081, 'config_multiple_instance': True, 'config_enable_file_cache': True, 'config_start_browser': True, 'config_resourcepath': './temporary/'}
