...
class timeCorrelatedMeasurements(App):
    ...
    def construct_ui(self):
        ...
        pulse12Same.attributes.update({"class":"checkbox","value":"","type":"checkbox","autocomplete":"off","checked":"checked","editor_constructor":"(False,'')","editor_varname":"pulse12Same","editor_tag_type":"widget","editor_newclass":"False","editor_baseclass":"CheckBox"})
        ...
        textToBeDisplayed.style.update({"margin":"0px","width":"89%","height":"80%","top":"10%","left":"2%","position":"absolute","overflow":"auto","font-size":"100%","font-style":"italic"})
        ...
        mainContainer.append(scanProgress,'scanProgress')
        statusPG = Svg(20,20)
