...
class MyApp(App):
    ...
    def main(self):
        ...
        tb.style.update({"margin":"0px","width":"40%","height":"95%","top":"3%","left":"5%","position":"absolute","overflow":"auto","background-color":"#e4e4e4","border-width":"0px","border-style":"None","border-color":"#a8a8a8"})
