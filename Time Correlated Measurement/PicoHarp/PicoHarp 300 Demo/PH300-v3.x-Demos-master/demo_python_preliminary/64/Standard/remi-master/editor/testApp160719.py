...
class timeCorrelatedMeasurements(App):
    ...
    def construct_ui(self):
        ...
        setPolarisation1Item1 = DropDownItem("POSTV")
        setPolarisation1Item2 = DropDownItem("NEGTV")
        ...
        setPolarisation2Item1 = DropDownItem("POSTV")
        setPolarisation2Item2 = DropDownItem("NEGTV")
        ...
        binWidthValue.style.update({"margin":"0px","width":"43%","height":"100%","top":"20px","position":"static","overflow":"auto","order":"-1","border-color":"#c0c0c0","border-style":"solid","background-color":"#ffffff"})
...
if __name__ == "__main__":
    start(timeCorrelatedMeasurements, address='127.0.0.1', port=8081, multiple_instance=False,enable_file_cache=True, update_interval=0.1, start_browser=True)
